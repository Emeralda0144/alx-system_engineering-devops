...
### __3. Add a route with query parameters__
...
Let’s serve what you built for [AirBnB clone v3 - RESTful API](https://alx-intranet.hbtn.io/projects/301) on `web-01`.
...
* It may be helpful to import your data (and environment variables) from this [project](https://alx-intranet.hbtn.io/projects/289)
...
```
### __5. Serve your AirBnB clone__
Let’s serve what you built for [AirBnB clone - Web dynamic](https://alx-intranet.hbtn.io/projects/309) on `web-01`.
