...
* You must use [get](https://docs.python.org/3.4/library/stdtypes.html#dict.ge) to access to dictionary value by key (it won’t throw an exception if the key doesn’t exist in the dictionary)
